...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.chunks.driver' => 'string',
            'filesystems.disks.chunks.root' => 'string',
            'filesystems.disks.chunks.throw' => 'boolean',
            'filesystems.disks.chunks.report' => 'boolean',
            'filesystems.disks.chunks.serve' => 'boolean',
            'filesystems.disks.chunks_assembled.driver' => 'string',
            'filesystems.disks.chunks_assembled.root' => 'string',
            'filesystems.disks.chunks_assembled.throw' => 'boolean',
            'filesystems.disks.chunks_assembled.report' => 'boolean',
            'filesystems.disks.chunks_assembled.serve' => 'boolean',
            'filesystems.disks.shares_staging.driver' => 'string',
            'filesystems.disks.shares_staging.root' => 'string',
            'filesystems.disks.shares_staging.throw' => 'boolean',
            'filesystems.disks.shares_staging.report' => 'boolean',
            'filesystems.disks.shares_staging.serve' => 'boolean',
            'filesystems.disks.shares.driver' => 'string',
            'filesystems.disks.shares.root' => 'string',
            'filesystems.disks.shares.throw' => 'boolean',
            'filesystems.disks.shares.report' => 'boolean',
            'filesystems.disks.shares.serve' => 'boolean',
            'filesystems.links./Users/dean/dprojects/erugo/public/storage' => 'string',
            'jwt.secret' => 'string',
            ...
            'twigbridge.twig.extension' => 'string',
            'twigbridge.twig.environment.debug' => 'boolean',
            'twigbridge.twig.environment.charset' => 'string',
            'twigbridge.twig.environment.cache' => 'NULL',
            'twigbridge.twig.environment.auto_reload' => 'boolean',
            'twigbridge.twig.environment.strict_variables' => 'boolean',
            'twigbridge.twig.environment.autoescape' => 'string',
            'twigbridge.twig.environment.optimizations' => 'integer',
            'twigbridge.twig.safe_classes.Illuminate\Contracts\Support\Htmlable' => 'array',
            'twigbridge.twig.globals' => 'array',
            'twigbridge.extensions.enabled' => 'array',
            'twigbridge.extensions.facades' => 'array',
            'twigbridge.extensions.functions' => 'array',
            'twigbridge.extensions.filters.get' => 'string',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','css-inliner.css-files','database.default',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.chunks.driver',
'filesystems.disks.chunks.root','filesystems.disks.chunks.throw','filesystems.disks.chunks.report','filesystems.disks.chunks.serve','filesystems.disks.chunks_assembled.driver',
'filesystems.disks.chunks_assembled.root','filesystems.disks.chunks_assembled.throw','filesystems.disks.chunks_assembled.report','filesystems.disks.chunks_assembled.serve','filesystems.disks.shares_staging.driver',
'filesystems.disks.shares_staging.root','filesystems.disks.shares_staging.throw','filesystems.disks.shares_staging.report','filesystems.disks.shares_staging.serve','filesystems.disks.shares.driver',
'filesystems.disks.shares.root','filesystems.disks.shares.throw','filesystems.disks.shares.report','filesystems.disks.shares.serve','filesystems.links./Users/dean/dprojects/erugo/public/storage',
...
'session.secure','session.http_only','session.same_site','session.partitioned','twigbridge.twig.extension',
'twigbridge.twig.environment.debug','twigbridge.twig.environment.charset','twigbridge.twig.environment.cache','twigbridge.twig.environment.auto_reload','twigbridge.twig.environment.strict_variables',
'twigbridge.twig.environment.autoescape','twigbridge.twig.environment.optimizations','twigbridge.twig.safe_classes.Illuminate\\Contracts\\Support\\Htmlable','twigbridge.twig.globals','twigbridge.extensions.enabled',
'twigbridge.extensions.facades','twigbridge.extensions.functions','twigbridge.extensions.filters.get','hashing.driver','hashing.bcrypt.rounds',
...
'sanctum.csrf-cookie','users.createFirstUser','auth.login',
'auth.refresh','auth.logout','auth.forgotPassword','auth.resetPassword','profile.view',
'profile.update','profile.unlinkProvider','users.create','users.index','users.update',
'users.delete','settings.write','settings.writeLogo','backgrounds.list','backgrounds.upload',
'backgrounds.delete','settings.read','settings.readGroup','shares.create','shares.myShares',
'shares.expire','shares.extend','shares.setDownloadLimit','shares.pruneExpired','themes.save',
'themes.list','themes.delete','themes.setActive','themes.install','auth-providers.index',
'auth-providers.listAvailableProviderTypes','auth-providers.create','auth-providers.bulkUpdate','auth-providers.update','auth-providers.delete',
'auth-providers.getCallbackUrl','email-templates.index','email-templates.update','reverse-shares.createInvite','reverse-shares.acceptInvite',
'auth-providers.list','themes.getActive','shares.read','shares.download','backgrounds.list',
'backgrounds.useThumb','backgrounds.use','uploads.createSession','uploads.chunk','uploads.finalize',
'uploads.createShareFromChunks','social.provider.login','social.provider.callback','social.provider.link','storage.shares',);
        registerArgumentsSet('views', 
'app','shares.failed','shares.pending','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'LOG_LEVEL','DB_CONNECTION','DB_DATABASE','JWT_SECRET','JWT_ALGO',
'VITE_API_URL','WWWGROUP','WWWUSER','APP_PORT','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_URL','AWS_ENDPOINT',);
